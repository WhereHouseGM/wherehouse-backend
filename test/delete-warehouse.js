module.exports = (dependencies) => {
	const { describe, before, it, setupDatabase, db, deleteWarehouse, postWarehouse, signUp, factories, expect } = dependencies;
	describe("delete warehouse", function() {
		...
		it("failed due to another users access token", async function() {
			const anotherUserSignUpResponse = await signUp(factories.users.newUser());
